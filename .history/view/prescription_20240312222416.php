          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              foreach ($cart as $item) {
                if ($item['approved'] == 1) {
                  echo displayPresc($item['medicine_id'], $item['img_url'], $item['medicine_name'], $item['qty'], $item['desc'],$item['price']);
                }
              }
            ...
            <tbody>
              ...
              foreach ($cart as $item) {
                if ($item['approved'] == 0) {
                  ...
                  echo displayPresc($item['medicine_id'], $item['img_url'], $item['medicine_name'], $item['qty'], $item['description']);
                }
              }
