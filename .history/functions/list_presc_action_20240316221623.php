...
<?php
function displayPresc($pid,$mid, $url, $med_name, $medicine_qty, $desc,$name)
{
    $cart_item = "
...
<input type='text' name='med_id' value='" . $mid . "' hidden/> 
                    ...
                    <button class='btn btn-primary  view-profile-button' data-toggle='modal' data-target='#profileModal' data-name='".$name."' data-desc='".$desc."'>View Buyer Profile</button><br/>
