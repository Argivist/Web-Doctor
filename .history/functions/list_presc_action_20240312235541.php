...
<input type='text' name='med_id' value='" . $mid . "' hidden/> 
                    ...
                    <td>
                    <button class='btn btn-primary safer validate-button' data-product-name='ClaCore'>Validate Prescription</button><br/>
                    ...
                    <button class='btn btn-primary danger reject-button' data-toggle='modal' data-target='#reasonModal' data-product-name='ClaCore'>Reject Prescription</button><br/>
