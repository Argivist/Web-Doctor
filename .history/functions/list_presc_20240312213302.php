...
<?php
function displayCart($mid, $url, $med_name, $medicine_qty)
{
    $cart_item = "
<tr>
<input type='text' name='med_id' value='" . $mid . "' hidden/> 
                    ...
                    <td>
                      <div class='input-group mb-3' style='max-width: 120px;'>
                        ...
                        <a href='../actions/update_qty.php?action=1&m_id=".$mid."'><button class='btn btn-outline-primary js-btn-minus' type='button'>&minus;</button></a>
                        </div>
