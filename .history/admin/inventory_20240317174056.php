  ...
  function renderInventory() {
    ...
    inventory.forEach(item => {
      ...
      tr.innerHTML = `
            ...
            <td>${item.name}</td>
            <td>${item.quantity}</td> 
            <td><button class="btn danger btn-primary " name="mid" value="${item.id}"onclick="removeItem(${item.id})">Remove</button><br/><button class="btn" name="mid" value="${item.id}" onclick="updateItem(${item.id})">Update</button></td>
        `;
