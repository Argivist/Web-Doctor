    ...
    <div class="site-wrap">
        ...
        <div class="popup-item">
          <div class="popup-header">
            ...
            <span class="close" onclick="closePopup('popup')">&times;</span>
          </div>
          <div class="popup-body">
            <form action="../actions/add_presc.php" method="post" enctype="multipart/form-data">
              <div class="form-group  mb-2">
                <label for="medicine">Medicine ID</label>
                <input type="text" class="form-control" id="medicine" name="medicine Id" required>
                <label for="patient"> Patient ID</label>
                <input type="text" class="form-control" id="patient" name="patient Id" required>
