  ...
  <div class="site-wrap">
    ...
    <div class="container">
      <div class="site-blocks-table">
        ...
        <center><button class="btn btn-primary " onclick="addItem()">Add New Item</button></center>
  ...
  function renderInventory() {
    ...
    inventory.forEach(item => {
      ...
      tr.innerHTML = `
            ...
            <td>${item.name}</td>
            <td>${item.quantity}</td> 
            <td><button class="btn btn-primary " name="mid" value="${item.id}" onclick="updateItem(${item.id})">Update</button><br/><button class="btn danger btn-primary " name="mid" value="${item.id}"onclick="removeItem(${item.id})">Remove</button><</td>
        `;
...
<div id="addItemModal" class="popup" style="display: block;">
    <div class="popup-item">
        <form action="../actions/update_inventory_action.php" method="POST">
            ...
            <input type="text" id="productName" name="prodName" value="${medinv['medicine_name']}" placeholder="Product Name"><br>
            ...
            <label for="desc">Description</label><bbr/>
