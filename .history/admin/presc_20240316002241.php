                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($cart as $item) {
                            ...
                            echo displayPresc($items["prescript_id"],$item['medicine_id'], $item['img_url'], $item['medicine_name'], $item['qty'], $item['desc'], $item['medicine_price']);
                        }
...
<script>
    $(document).ready(function() {
        ...
        $('.validate-button').click(function() {
            ...
            var productName = $(this).data('product-id');
            alert(productName);
