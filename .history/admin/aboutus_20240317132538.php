      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="../img/background/bg_1.jpg" alt="Image placeholder" class="img-fluid rounded">
...
<!-- contact us -->
<div class="site-section bg-secondary text-light custom-border-bottom">
      <div class="container">
        <div class="row mb-5">
        <div class="col-md-5">
...
<p>Email: web.docs@null.com</p>
<p>Address: 123, Accra, Ghana</p>
